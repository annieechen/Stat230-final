...
####Dataset
Teaching and Learning International Survey (TALIS) Dataset.
...
* focused on lower secondary schools
* one column for each question on questionairre, as well as some summary columns for sections of the survey
* one row for each teacher response
* 36 countries in the dataset
...
x <- na.omit(teacher_data[, -(sat_indices)])
