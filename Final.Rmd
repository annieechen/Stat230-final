...
```{r}
teacher_data %>% ggplot(aes(x=age, y=sat_avg)) + geom_point(alpha=0.05)
teacher_data %>% ggplot(aes(x=years_teacher, y=sat_avg)) + geom_point(alpha=0.05)
teacher_data %>% ggplot(aes(x=age_start, y=sat_avg)) + geom_point(alpha=0.05)
teacher_data %>% ggplot(aes(x=age_ratio, y=sat_avg)) + geom_point(alpha=0.05)
```
...
x.new <- na.omit(x.new[, -which(names(x.new) %in% c("train_stat", "region", "age"))])
```
