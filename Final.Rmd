...
Each row of the dataset corresponds to single teacher's response to the questionnaire (There are 117876 rows).  The original dataset had 532 columns, which corresponded to either a particular question in the questionnaire, or a summary variable for a section of the questionnaire. After picking a subset of those columns and creating some of our own, we were left with 40 columns.
...
First, lets look at a map of average teacher satisfaction by country.
...
country_avg[order(country_avg$mean_satisfaction)[c(1,2, 3, 18,19,34,35,36)],]
