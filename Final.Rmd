...
Before we analyze the data any further, we should clean up the data slightly more.  We previously cleaned the dataset with respect to missing values and obvious errors.  However, when considering the context of some of our variables, some of the entries are still unusual.  
