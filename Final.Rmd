...
Lastly, let's look at the sign of the coefficients in the model, to see the direction of the relationships between the predictors and sat_avg.
...
```{r, ref.label=knitr::all_labels()[-"data_cleaning"],echo=TRUE,eval=FALSE}
...
```{r data_cleaning, eval=FALSE, echo=TRUE}
