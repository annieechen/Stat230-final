...
Given that there appear to be differences by region from the plots above, let's see if these differences are statistically significant using an anova test.  
