...
```{r, fig.height=2.5, fig.width=9, message=FALSE, warning=FALSE}
 par(mar=c(0,0,1,0))
mapParams1 <- mapCountryData(sPDF1, nameColumnToPlot = "mean_satisfaction", colourPalette="terrain", oceanCol = "lightblue", missingCountryCol="gray", addLegend = FALSE, mapTitle = "Mean Satisfaction By Country")
