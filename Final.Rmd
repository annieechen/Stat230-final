...
We can take a look at the histogram of the age_start variable - perhaps when you start teaching may affect how satisfied you are. Of course, if we interpret this variable directly as the age teachers start teaching, we are making an implicit assumption that they never took a break/time off. 
...
Overall, our models didn't explain very much of the variation in the data at all. We expected real datasets to be messier than the ones we had dealt with in problem sets, and so were pleased with the observations we did find.
